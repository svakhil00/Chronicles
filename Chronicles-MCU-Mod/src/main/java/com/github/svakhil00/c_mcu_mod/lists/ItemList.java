...
public class ItemList {
	...
	//blocks, ores
	public static final BlockItem VIBRANIUM_ORE_BLOCKITEM = new VibraniumOreBlockItem(BlockList.VIBRANIUM_ORE_BLOCK, new BlockItem.Properties().group(ModItemGroups.MOD_ITEM_GROUP));

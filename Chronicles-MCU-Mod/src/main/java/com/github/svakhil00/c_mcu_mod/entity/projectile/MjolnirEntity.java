...
public class MjolnirEntity extends AbstractArrowEntity {
	...
	public MjolnirEntity(final World WORLDIN) {
		this(CustomEntityType.MJOLNIR.orElseThrow(IllegalStateException::new), WORLDIN);
	}
	...
	public MjolnirEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
		super(CustomEntityType.MJOLNIR.orElseThrow(IllegalStateException::new), thrower, worldIn);
	...
	public MjolnirEntity(World worldIn, double x, double y, double z) {
		super(CustomEntityType.MJOLNIR.orElseThrow(IllegalStateException::new), x, y, z, worldIn);
	}
		...
		if ((this.dealtDamage || this.getNoClip()) && entity != null) {
			if (!this.shouldReturnToThrower()) {
				...
				if (this.returningTicks == 0) {
					this.playSound(ModEventSubscriber.ITEM_MJOLNIR_LIGHTNING, 10.0F, 1.0F);
				}

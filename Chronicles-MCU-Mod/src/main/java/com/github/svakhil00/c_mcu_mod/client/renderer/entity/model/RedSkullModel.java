...
public class RedSkullModel<T extends RedSkullEntity> extends SegmentedModel<T> {
	...
	public RedSkullModel() {
		...
		body.addBox(1.0F, 0.0F, -2.0F, 3, 12, 4, 0.5F);
		body.addBox(-4.0F, 0.0F, -2.0F, 3, 12, 4, 0.5F);
		body.addBox(0.0F, 0.0F, -1.0F, 1, 12, 3, 0.5F);
		...
		rightArm.addBox(-1.0F, -2.0F, -2.0F, 4, 11, 4, 0.5F);

		leftArm = new ModelRenderer(this);
		leftArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
		body.addChild(leftArm);
		leftArm.addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
		leftArm.addBox(-3.0F, -2.0F, -2.0F, 4, 11, 4, 0.5F);

		rightLeg = new ModelRenderer(this);
		rightLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
		rightLeg.addBox(-1.85F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		rightLeg.addBox(-1.65F, 0.0F, -2.0F, 4, 11, 4, 0.25F);

		leftLeg = new ModelRenderer(this);
		leftLeg.setRotationPoint(-1.9F, 12.0F, 0.0F);
		leftLeg.addBox(-2.15F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		leftLeg.addBox(-2.35F, 0.0F, -2.0F, 4, 11, 4, 0.25F);
	}

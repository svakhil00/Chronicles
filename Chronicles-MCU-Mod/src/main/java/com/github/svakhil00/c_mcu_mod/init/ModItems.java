...
public class ModItems {
	...
	public static final Item IRON_MAN_BOOTS= new IronManSuitItem(ModArmorTierMaterial.iron_man_suit, EquipmentSlotType.FEET, new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP));
